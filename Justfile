...
doctor:
    @echo "Running diagnostics for SiliconCore.jl..."
...
help-me:
    @echo "=== SiliconCore.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/SiliconCore.jl/issues/new"
    @echo ""
